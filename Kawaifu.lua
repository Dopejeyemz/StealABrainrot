...
-- Текст https://discord.gg/dFEPdhP73 (серый, без перелива)
local madeByLabel = Instance.new("TextLabel")
madeByLabel.Size = UDim2.new(1, 0, 0, 18)
madeByLabel.Position = UDim2.new(0, 0, 0, 30)
madeByLabel.BackgroundTransparency = 1
madeByLabel.Text = "https://discord.gg/dFEPdhP73"
...
panelSubtitle.Text = "https://discord.gg/dFEPdhP73"
